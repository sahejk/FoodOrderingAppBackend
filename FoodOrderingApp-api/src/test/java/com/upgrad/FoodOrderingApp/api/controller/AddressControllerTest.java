...
public class AddressControllerTest {
    ...
    public void shouldSaveAddress() throws Exception {
        ...
        when(mockAddressService.getStateByUUID("testUUID")).thenReturn(new StateEntity("testUUID","testName"));
    ...
    public void shouldGetAllAddresses() throws Exception {
        ...
        addressEntity.setStateName(new StateEntity(1l, stateUuid, "state"));
        when(mockAddressService.getAllAddress(customerEntity)).thenReturn(Collections.singletonList(addressEntity));
        when(mockAddressService.getStateByUUID(anyString())).thenReturn(new StateEntity("testUUId","testName"));
